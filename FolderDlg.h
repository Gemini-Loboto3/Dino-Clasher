...
public:	
	inline LPCTSTR GetFolderPath()  const;
	inline LPCTSTR GetFolderName()  const;
	inline int GetFolderImage() const;		
	inline LPCTSTR GetSelectedFolder() const;

	inline BROWSEINFO& GetBI();
	inline const BROWSEINFO& GetBI() const;
